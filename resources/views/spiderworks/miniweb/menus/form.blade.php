                            ...
                            <div class="row column-seperation padding-5">
                                <div class="form-group form-group-default form-group-default-select2 required">
                                  ...
                                  <select name="position" class="full-width miniweb-select2-input">
                                    ...
                                    <option value="Footer1" @if($obj->position == 'Footer1') selected="selected" @endif>Footer 1</option>
                                    <option value="Footer2" @if($obj->position == 'Footer2') selected="selected" @endif>Footer 2</option>
                                    <option value="Footer3" @if($obj->position == 'Footer3') selected="selected" @endif>Footer 3</option>
                                    <option value="Footer4" @if($obj->position == 'Footer4') selected="selected" @endif>Footer 4</option>
                                    <option value="Bottom" @if($obj->position == 'Bottom') selected="selected" @endif>Bottom</option>
                                    <option value="Extra-Footer" @if($obj->position == 'Extra-Footer') selected="selected" @endif>Extra-Footer</option>
                                    <option value="NewHeader" @if($obj->position == 'NewHeader') selected="selected" @endif>NewHeader</option>
