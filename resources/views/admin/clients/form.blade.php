...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="margin-bottom: 20px;" align="right">
            @if($obj->id)
                <span class="page-heading">EDIT CLIENT</span>
            @else
                <span class="page-heading">CREATE NEW CLIENT</span>
            @endif
            <div >
                <div class="btn-group">
        ...
        <div class="col-lg-12">
            <div class="card card-borderless">
                ...
                <ul class="nav nav-tabs nav-tabs-simple d-none d-md-flex d-lg-flex d-xl-flex" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    ...
                    <li class="nav-item">
                        <a @if($tab == 'service') class="active show" @endif data-toggle="tab" role="tab"
                                ...
                                <div class="row">
                                    ...
                                    <div class="default-image-holder padding-5">
                                        ...
                                        <a href="{{route('spiderworks.miniweb.media.popup', ['popup_type'=>'single_image', 'type'=>'Image', 'holder_attr'=>'0'])}}" class="miniweb-open-ajax-popup" title="Media Images" data-popup-size="large" id="image-holder-0">
                                          @if($obj->logo_id_1 && $obj->logo1)
                                            <img class="card-img-top padding-20" src="{{ asset('public/'.$obj->logo1->thumb_file_path) }}">
                                          @else
                                            <img class="card-img-top padding-20" src="{{asset('assets/img/add_image.png')}}">
                                          @endif
                                        </a>
                                        <input type="hidden" name="logo_id_1" id="mediaId0" value="{{$obj->logo_id_1}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <p class="col-md-12">Logo2</p>
                                    <div class="default-image-holder padding-5">
                                        ...
                                        <a href="{{route('spiderworks.miniweb.media.popup', ['popup_type'=>'single_image', 'type'=>'Image', 'holder_attr'=>'1'])}}" class="miniweb-open-ajax-popup" title="Media Images" data-popup-size="large" id="image-holder-1">
                                          @if($obj->logo_id_2 && $obj->logo2)
                                            <img class="card-img-top padding-20" src="{{ asset('public/'.$obj->logo2->thumb_file_path) }}">
                                          @else
                                            <img class="card-img-top padding-20" src="{{asset('assets/img/add_image.png')}}">
                                          @endif
                                        </a>
                                        <input type="hidden" name="logo_id_2" id="mediaId1" value="{{$obj->logo_id_2}}">
                                    </div>
                              </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane @if($tab == 'service') active show @endif" id="tabService">
                        @php
