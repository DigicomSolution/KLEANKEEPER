...
use App\Models\Homies;
use View,Redirect, DB;

class HomiesController extends BaseController
{
    use ResourceTrait;
    ...
    public function __construct()
    {
        ...
        $this->model = new Homies;
        $this->route = 'admin.homies';
        $this->views = 'admin.homies';
    ...
    public function store(HttpRequest $r)
    {
        ...
        $this->model->save();
        return Redirect::to(url('admin/homies/edit', array('id'=>encrypt($this->model->id))))->withSuccess('Homie successfully saved!'); 
    }
    ...
    public function update(HttpRequest $r)
    {
        ...
        if($obj = $this->model->find($id)){
            ...
            return Redirect::to(url('admin/homies/edit', array('id'=>encrypt($obj->id))))->withSuccess('Homie details successfully updated!');
        } else {
