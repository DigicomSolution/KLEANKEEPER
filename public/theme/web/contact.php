...
<section class="contact-sec">
    <div class="container ct-container">
        <div class="con-left-img">
            <img src="img/tree.png" alt="">
        </div>
        <div class="con-rt-img">
            <img src="img/window.png" alt="">
        </div>
        <div class="cloud-img">
            <img src="img/cloud.png" alt="">
        </div>
        <div class="cloud-rt-img">
            <img src="img/cloud.png" alt="">
        </div>
        <div class="row justify-content-center ct-row">
            <div class="col-md-5 col-lg-6 p-0">
                <div class="contact-inner">
                    <div class="ct-hd">
                        <span class="ct-span">Lets Have</span>
                    ...
                    <form>
                        ...
                        <div class="row justify-content-between p-15px">
                            <div class="ct-dec">
...
<section class="schedule-meeting">
    <div class="container">
        <div class="scm-hd">
            <h2>
                <span class="sc-span">Schedule</span>
                <span> Meeting</span>
            </h2>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-6">
                <div class="sm-single bd-rt">
                    <div class="sm-icon">
