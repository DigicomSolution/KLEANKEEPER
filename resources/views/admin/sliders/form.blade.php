                ...
                <div class="row m-2">
                    ...
                    <div class="row">
                        <div class="col-md-12" align="right">
                            <a href="{{url('admin/media/popup', ['popup_type'=>'sliders-'.$obj->id, 'type'=>'Image'])}}" class="miniweb-open-ajax-popup btn btn-primary" title="Media Images" data-popup-size="large"><i class="glyphicon glyphicon-plus-sign"></i> Add Photos</a>
...
@section('bottom')
    ...
    <script src="{{ asset('assets/cropper/js/common.js')}}"></script>
