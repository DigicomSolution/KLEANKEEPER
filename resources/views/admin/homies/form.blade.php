...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="margin-bottom: 20px;" align="right">
            @if($obj->id)
                <span class="page-heading">EDIT HOMIE</span>
            @else
                <span class="page-heading">CREATE NEW HOMIE</span>
            @endif
            <div >
                <div class="btn-group">
                            ...
                            <div class="col-md-12">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" name="sub_heading" class="form-control" value="{{$obj->sub_heading}}" id="sub_heading">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default required">
                                        <label>Total Project Count</label>
                                        <input type="text" name="project_count" class="form-control" value="{{$obj->project_count}}" id="project_count">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default required">
                                        <label>Project Count Display Title</label>
                                        <input type="text" name="project_display_title" class="form-control" value="{{$obj->project_display_title}}" id="project_display_title">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
