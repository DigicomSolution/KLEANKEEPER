        ...
        <div class="col-md-12" style="margin-bottom: 20px;" align="right">
            ...
            <div >
                <div class="btn-group">
                   ...
                   @if($obj->slug != "home-footer")  <a href="{{route($route.'.destroy', [encrypt($obj->id)])}}" class="btn btn-success miniweb-btn-warning-popup" data-message="Are you sure to delete?  Associated data will be removed if it is deleted." data-redirect-url="{{route($route.'.index')}}"><i class="fa fa-trash"></i> Delete</a>
                    @endif
                    @endif
                </div>
            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row column-seperation padding-5">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" name="slug" class="form-control" value="{{$obj->slug}}" @if($obj->slug == "home-footer") readonly @endif id="slug">
                                    </div>
