                            ...
                            <div class="col-md-6">
                                    <div class="row column-seperation padding-5">
                                        <div class="form-group form-group-default form-group-default-select2">
                                            ...
                                            <select name="department_id" class="full-width miniweb-select2-input" data-select2-url="{{route('select2.departments')}}" data-placeholder="Select a Department">
                                                @if($obj->department)
                                                    <option value="{{$obj->department->id}}" selected="selected">{{$obj->department->name}}</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div>
