...
<html class="no-js" lang="en">
    ...
    <meta property="og:description" content="@yield('og_description', 'Klean Keepers is one of the leading home service companies in London, providing commercial and domestic services for homes, offices, leisure centres, community centres and more. Contact now for home services in London.')">
    ...
    <meta name="description" content="@yield('description', 'Klean keepers makes it easy for you to order all kinds of home services that will be delivered to your door step through our apps or website.')" />
...
<body class="klean">
    ...
    @include('client.include.script_new')
