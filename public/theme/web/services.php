...
<!-- digital cosultancy -->
<section class="digital-cosultancy pt100">
    <div class="container">
        <div class="row sm-row">
            <div class="col-md-6">
                <div class="bt-left-img">
                    <img src="img/consultancy.png" alt="Klean Keepers image {{ rand(100000, 99999999) }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="bt-hd">
...
<section class="sm-marketing pb100">
    <div class="container">
        <div class="row sm-row">
            <div class="col-md-6">
                <div class="bt-left-img">
                    <img src="img/social-media.png" alt="Klean Keepers image {{ rand(100000, 99999999) }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="bt-hd">
...
<!-- end -->
<!-- commitments -->
<section class="more-in-house pt100">
    <div class="container">
        <div class="mih-hd">
            <h2>More in the House</h2>
        </div>
        <div class="row mih-row ptb60">
            <div class="col-md-6">
...
<section class="trusted-brands tb-services ptb60">
    <div class="container">
