...
class DepartmentController extends BaseController
{
    ...
    public function store(HttpRequest $r)
    {
        ...
        $this->model->save();
        return Redirect::to(url('admin/departments/edit', array('id'=>encrypt($this->model->id))))->withSuccess('Department successfully saved!'); 
    }
    ...
    public function update(HttpRequest $r)
    {
        ...
        if($obj = $this->model->find($id)){
            ...
            return Redirect::to(url('admin/departments/edit', array('id'=>encrypt($obj->id))))->withSuccess('Department details successfully updated!');
        } else {
