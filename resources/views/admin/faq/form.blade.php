                           ...
                           @if(count($obj->question_answers)>0)     
                              ...
                              <div class="row w-100 mb-2 descriptionwrapper" >
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        <label>Answer</label>
                                                        <textarea name="faq[{{$key}}][answer]" class="form-control ">{{$value->answer}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 text-right">
                                                    <button type="button" id="delete" class="btn btn-danger btn-sm remove">Remove</button>
                                                </div>
                                            </div> 
                            @endforeach
                            @endif
                              <div class="row w-100 mb-2 descriptionwrapper" >
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                <label>Answer</label>
                                                <textarea name="faq[{{$count}}][answer]" class="form-control "></textarea>
                                            </div>
                                        </div>
                                    </div>  
                        </div>
...
@section('bottom')
    <script type="text/javascript">
        ...
        $("#add").click(function(){
            i++;
            $("#box").append('<div class="row w-100 mb-2 descriptionwrapper" ><div class="col-md-12"><div class="form-group "><label>Question</label><textarea name="faq['+i+'][question]" class="form-control" /></div></div><div class="col-md-12"><div class="form-group "><label>Answer</label><textarea name="faq['+i+'][answer]" class="form-control richtext" /></div></div><div class="col-md-12 text-right"><div class="form-group "><button type="button" class="btn btn-danger btn-sm remove" >Remove</button></div></div></div>');
            $('.richtext').summernote({
                callbacks: {
